...
namespace GaAutoTestSystem
{
    internal class FitnessFunctionLib
    {
        ...
        public static double Branch1_Coverage(params double[] paras)
        {
            var x = paras[0];
            var y = paras[1];
            var path = "#";
        ...
        public static double Branch1_Distance(params double[] paras)
        {
            var x = paras[0];
            var y = paras[1];
        ...
        public static double Branch2_Coverage(params double[] paras)
        {
            double k = 0;
            double j = 0;
            var x = (int) paras[0];
...
//                                    path += "v";
        ...
        public static double NextDate_Distance(params double[] paras)
        {
            var year = (int) paras[0];
            var month = (int) paras[1];
            var day = (int) paras[2];
